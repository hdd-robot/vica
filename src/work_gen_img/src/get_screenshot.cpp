  ...
  while (ros::ok())
  {
    if ( cv_ptr1 && cv_ptr2 )
    {
     ...
     //  cv::imshow(OPENCV_WINDOW_3, image3);
       ...
       std::stringstream ss;
       ss << "/home/ros/workspace_vica/src/work_gen_img/img/box/rgb/img_" << count << ".jpg" ;
       imwrite( ss.str(), image1 );

       ss << "/home/ros/workspace_vica/src/work_gen_img/img/box/depth/img_" << count << ".jpg" ;
       imwrite( ss.str(), image2 );

       ss << "/home/ros/workspace_vica/src/work_gen_img/img/box/pcl/img_" << count << ".pcd" ;
